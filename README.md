...
**Project**: wedding-fun-fact-frenzy 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: an app for a wedding where guests can upload fun facts about the bride and groom, and creates a game afterwards where people can guess what fun fac corrsponds to who 
...
```sh
git clone https://github.com/GPT-Engineer-App/wedding-fun-fact-frenzy.git
cd wedding-fun-fact-frenzy
npm i
